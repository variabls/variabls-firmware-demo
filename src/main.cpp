...
void powerConsumption()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 1, powerConsumption);
    }
}
...
void waterConsumption()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 2, waterConsumption);
    }
}
...
void voltageCurrentAir()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 3, voltage);
        sparksMQTT.publish("GDPS/office/Garuda", 4, current);
        sparksMQTT.publish("GDPS/office/Garuda", 5, air);
    }
}
...
void tempHumid()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 6, temp);
        sparksMQTT.publish("GDPS/office/Garuda", 7, humidity);
    }
}
...
void oxygen()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 8, oxy);
    }
}
...
void billing()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 9, billing);
    }
}
...
void thTemp()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 6, thTemperature);
    }
}
void thHumid()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 7, thHumidity);
    }
}
void thOxy()
{
    if (mqttClient.connected()){
        ...
        sparksMQTT.publish("GDPS/office/Garuda", 8, thOxygen);
    }
}
...
void setup()
{
    ...
    sparksMQTT.callbackControl("room1-lamp", "GDPS/office/Garuda", -1, satu);
    sparksMQTT.callbackControl("meetingRoom-lamp", "GDPS/office/Garuda", -2, dua);
    sparksMQTT.callbackControl("room2-lamp", "GDPS/office/Garuda", -3, tiga);
    sparksMQTT.callbackControl("mushalla-lamp", "GDPS/office/Garuda", -4, empat);
    sparksMQTT.callbackControl("toilet-lamp", "GDPS/office/Garuda", -5, lima);
    sparksMQTT.callbackControl("room3-AC", "GDPS/office/Garuda", -6, enam);
