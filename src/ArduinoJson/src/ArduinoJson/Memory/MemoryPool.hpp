...
#include <ArduinoJson/src/ArduinoJson/Memory/Alignment.hpp>
#include <ArduinoJson/src/ArduinoJson/Polyfills/assert.hpp>
#include <ArduinoJson/src/ArduinoJson/Polyfills/mpl/max.hpp>
#include <ArduinoJson/src/ArduinoJson/Variant/VariantSlot.hpp>
