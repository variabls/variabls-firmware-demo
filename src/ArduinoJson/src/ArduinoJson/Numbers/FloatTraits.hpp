...
#include <ArduinoJson/src/ArduinoJson/Polyfills/alias_cast.hpp>
#include <ArduinoJson/src/ArduinoJson/Polyfills/math.hpp>
#include <ArduinoJson/src/ArduinoJson/Polyfills/preprocessor.hpp>
#include <ArduinoJson/src/ArduinoJson/Polyfills/static_array.hpp>
